...
You can remove a specific track by running the `/remove` command with the ID of the track as the argument.
For example, if you would like to remove a track with the ID 1 you would run the following command:
