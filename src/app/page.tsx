        ...
        <main className={'min-h-screen'}>
            <div className='m-auto default-bg text-center pointer-events-none p-32 phone:px-8 phone:py-32'>
                ...
                <div className='flex phone:flex-col gap-6 pointer-events-auto justify-center'>
                    <Button className='phone:mx-auto' type={ButtonType.INVERTED} width={10} height={3} href={process.env.NEXT_PUBLIC_DISCORD_INVITE_LINK}>INVITE</Button>
                    <Button className='phone:mx-auto' type={ButtonType.INVERTED} width={10} height={3} href={process.env.NEXT_PUBLIC_DISCORD_INVITE_LINK}>LEARN MORE</Button>
                </div>
            </div>
        </main>
    )
