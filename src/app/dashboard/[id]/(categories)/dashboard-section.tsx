...
export default function DashboardSection(props: Props) {
    return (
        <section className='p-6 phone:p-0 mx-auto'>
            ...
            {props.description &&  <div className='bg-primary/10 dark:bg-dark/50 rounded-xl p-6 mb-12'><h3 className='text-xl text-secondary dark:text-white w-3/4'>{props.description}</h3></div>}
