    ...
    return (
        <main className='p-12 min-h-screen'>
            ...
            <div>
                ...
                <div className='grid grid-cols-3 dark:bg-neutral-900/50 bg-neutral-600/5 backdrop-blur-lg rounded-xl p-6 laptop-big:grid-cols-2 phone:grid-cols-1  mt-6 place-items-center gap-12 phone:gap-3'>
