...
const lightTheme = createTheme({
    ...
    theme: {
        colors: {
            ...
            primarySolidContrast: '$green500', // commonly used for text inside the component
            ...
            secondarySolidContrast: '$green600', // commonly used for text inside the component
            ...
            warningSolidContrast: '$amber500', // commonly used for text inside the component
            ...
            errorSolidContrast: '$red500', // commonly used for text inside the component
            errorShadow: '$red500'
        },
        fonts: {
